...
class GReadPhotonGrISU: public GReadPhotonBase {
  ...
  double fSEmProbability; //!< primary emergence probability
 ...
 public:
  ...
  bool getPrimary(ROOT::Math::XYZVector *pCore, 
                  ...
                  double *Zn, double *energy,double *EmProbability, unsigned int *particleType,
  ...
  long getLinesRead() const override { return lLinesRead; }
