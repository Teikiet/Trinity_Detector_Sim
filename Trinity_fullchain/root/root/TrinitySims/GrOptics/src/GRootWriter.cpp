   ...
   iNInitReserve(iNInitEvents)
{
 ...
 // define trees with pe data
  ...
  fTree->Branch("emergenceProbability", &fEmergenceProbability, "emergenceProbability/F" );
...
int GRootWriter::addEvent(const unsigned int &eventNumber, const unsigned int &primaryType, 
			  const double &primaryEnergy, const double &emergenceProbability, const ROOT::Math::XYZVector &vSCore,
  ...
  fEmergenceProbability = (float)emergenceProbability;
