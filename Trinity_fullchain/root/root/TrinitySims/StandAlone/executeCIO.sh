...
cd /storage/hive/project/phy-otte/shared/analysistools/TrinitySims/corsikaIOreader
#ARGS="/storage/hive/project/phy-otte/omatamala3/Sims/RunPyLauncher.py ${INFILE}"
