...
void VGrisu::writeRunHeader( float* buf1, VCORSIKARunheader* f )
{
    if( !bSTDOUT )
    {
        ...
        of_file << "\t\t\t Telescope position relative to emergence (x,y,z) [m]: " << buf1[269] << "\t" << buf1[270] << "\t" << buf1[271] << endl;
    ...
    else
    {
        ...
        cout << "\t\t\t Telescope position relative to emergence (x,y,z) [m]: " << buf1[269] << "\t" << buf1[270] << "\t" << buf1[271] << endl;
...
void VGrisu::writeEvent( telescope_array array, bool printMoreInfo )
{
    ...
    if( !bSTDOUT )
    {
        ...
        of_file << " " << -1;
        of_file << " " << -1;
        of_file << " " << setprecision( 7 ) << array.shower_sim.emergence_probability;
        of_file << endl;
    }
    else
    {
        ...
        cout << " " << -1;
        cout << " " << -1;
        cout << " " << setprecision( 7 ) << array.shower_sim.emergence_probability;
        cout << endl;
    }
...
void VGrisu::writePhotons( bunch i_bunch, int i_tel )
{
    ...
    float x = i_bunch.x;
    float y = i_bunch.y;
//    cout<<i_bunch.cy<<" "<<i_bunch.cx<<endl;
    float az = atan2( i_bunch.cy, i_bunch.cx );
    double ze = 1. - ( i_bunch.cx * i_bunch.cx + i_bunch.cy * i_bunch.cy );
//    cout<<ze<<endl;
    if( ze > 0. )
    {
        ze = sqrt( ze );
    ...
    if( !bSTDOUT )
    {
        ...
        of_file << setprecision(0)<<i_bunch.photons;
	of_file << endl;
	...
	cout << setprecision(0)<<i_bunch.photons;
        cout << endl;
